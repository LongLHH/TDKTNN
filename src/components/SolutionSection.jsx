            ...
            {activePillar && (
              ...
              {activePillar === 1 && (
                ...
                >
                  ...
                  {/* PHẦN PSO - MINH BẠCH HÓA GIỮ GIÁ ĐIỆN */}
                  <motion.div
                    initial={{ opacity: 0, y: 30 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 1 }}
                  ...
                  >
                    <div className="text-center mb-10">
                      <motion.h4 
                        className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-yellow-400 to-orange-400 mb-4"
                        animate={{ backgroundPosition: ['0%', '100%', '0%'] }}
                        transition={{ duration: 3, repeat: Infinity }}
                      >
                        💰 MINH BẠCH HÓA NHIỆM VỤ GIỮ GIÁ ĐIỆN (PSO) 💰
                      </motion.h4>
                      <p className="text-purple-200 text-lg">
                        So sánh 2 cơ chế: Ép lỗ vs Đặt hàng
                      </p>
                    </div>

                    {/* 2 CARDS - OLD VS NEW */}
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                      {/* CARD 1: CÁCH CŨ - ÉP LỖ */}
                      <motion.div
                      ...
                      >
                        <div className="relative bg-gradient-to-br from-red-950 via-red-900 to-orange-950 rounded-3xl p-8 border-4 border-red-500 shadow-2xl overflow-hidden h-full">
                          {/* Pattern background */}
                          ...
                          {/* Badge */}
                          <div className="absolute -top-4 -right-4 bg-red-600 text-white font-bold py-3 px-8 rounded-full shadow-lg rotate-12 z-10">
                            ❌ CÁCH CŨ
                          </div>
                          ...
                          <div className="relative z-10">
                            ...
                            <div className="text-center mb-6">
                              ...
                              <h5 className="text-3xl font-bold text-red-300 mb-2">
                                CƠ CHẾ "ÉP"
                              </h5>
                              <p className="text-red-200 text-sm italic">
                                (Thiếu minh bạch, EVN gánh lỗ)
                              </p>
                            </div>
                            ...
                            <div className="space-y-4 mb-6">
                              <motion.div
                                ...
                                className="bg-red-900/50 rounded-xl p-4 border-2 border-red-500/50"
                              >
                                <div className="flex items-center gap-3 mb-2">
                                  <span className="text-3xl">⚡</span>
                                  <span className="text-red-200 font-bold">Giá đầu vào</span>
                                </div>
                                <p className="text-white text-2xl font-bold pl-10">
                                  2.500đ/kWh
                                </p>
                                <p className="text-red-300 text-sm pl-10">
                                  (Than, khí, vận hành...)
                                </p>
                              </motion.div>
                              ...
                              <motion.div
                                ...
                                className="bg-gray-900/80 rounded-xl p-4 border-2 border-red-500"
                              >
                                <div className="flex items-center gap-3 mb-2">
                                  <span className="text-3xl">🏛️</span>
                                  <span className="text-yellow-300 font-bold">Chính phủ chỉ đạo</span>
                                </div>
                                <p className="text-red-300 text-xl font-bold pl-10">
                                  "Bán giá 2.000đ/kWh"
                                </p>
                                <p className="text-red-200 text-sm pl-10">
                                  → Không được tăng giá!
                                </p>
                              </motion.div>
                              ...
                              >
                                <div className="flex items-center justify-between mb-2">
                                  <div className="flex items-center gap-3">
                                    <span className="text-3xl">⚡</span>
                                    <span className="text-red-200 font-bold">EVN</span>
                                  </div>
                                  <div className="text-3xl">→</div>
                                  <div className="flex items-center gap-3">
                                    <span className="text-3xl">👥</span>
                                    <span className="text-red-200 font-bold">Dân</span>
                                  </div>
                                </div>
                              ...
                              <motion.div
                                ...
                                transition={{ delay: 2 }}
                                className="bg-gradient-to-r from-red-800 to-red-900 rounded-xl p-6 border-4 border-red-400"
                              >
                                <div className="text-center mb-3">
                                  <span className="text-5xl">💥</span>
                                  <p className="text-yellow-300 font-bold text-xl mt-2">HẬU QUẢ</p>
                                </div>
                                <div className="bg-red-950/70 rounded-lg p-4 mb-3">
                                  <motion.p 
                                    className="text-4xl font-bold text-red-300 text-center"
                                    animate={{ scale: [1, 1.2, 1] }}
                                    transition={{ repeat: Infinity, duration: 2 }}
                                  >
                                    EVN tự gánh lỗ
                                  </motion.p>
                                  <p className="text-3xl font-mono text-yellow-300 text-center mt-2">
                                    -500đ/kWh
                                  </p>
                                </div>
                                <div className="space-y-2 text-red-200 text-sm">
                                  <p className="flex items-center gap-2">
                                    <span>❌</span>
                                    <span>EVN Lỗ không rõ nguyên nhân</span>
                                  </p>
                                  <p className="flex items-center gap-2">
                                    <span>❌</span>
                                    <span>Ngân sách mập mờ</span>
                                  </p>
                                  <p className="flex items-center gap-2">
                                    <span>❌</span>
                                    <span>Không kiểm soát được chi phí PSO</span>
                                  </p>
                                </div>
                              </motion.div>
                            </div>
                      ...
                      <motion.div
                        ...
                        className="relative perspective-1000"
                      >
                        <div className="relative bg-gradient-to-br from-green-950 via-emerald-900 to-teal-950 rounded-3xl p-8 border-4 border-green-400 shadow-2xl overflow-hidden h-full">
                          {/* Pattern background */}
                          <div className="absolute inset-0 opacity-10"
                               style={{
                          ...
                          {/* Badge */}
                          <div className="absolute -top-4 -right-4 bg-green-600 text-white font-bold py-3 px-8 rounded-full shadow-lg -rotate-12 z-10">
                            ✅ CÁCH MỚI
                          </div>
                          ...
                          <div className="relative z-10">
                            ...
                            <div className="text-center mb-6">
                              <div className="text-6xl mb-3">🎯</div>
                              <h5 className="text-3xl font-bold text-green-300 mb-2">
                                CƠ CHẾ "ĐẶT HÀNG"
                              </h5>
                              <p className="text-green-200 text-sm italic">
                                (Minh bạch, công bằng cho mọi bên)
                              </p>
                            </div>
                            ...
                            <div className="space-y-4 mb-6">
                              <motion.div
                                ...
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ delay: 1.4 }}
                                className="bg-green-900/50 rounded-xl p-4 border-2 border-green-500/50"
                              >
                                <div className="flex items-center gap-3 mb-2">
                                  <span className="text-3xl">📊</span>
                                  <span className="text-green-200 font-bold">Giá thị trường</span>
                                </div>
                                <p className="text-white text-2xl font-bold pl-10">
                                  2.500đ/kWh
                                </p>
                                <p className="text-green-300 text-sm pl-10">
                                  (Tính toán công khai, minh bạch)
                                </p>
                              </motion.div>
                              ...
                              <motion.div
                                ...
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ delay: 1.6 }}
                                className="bg-blue-900/50 rounded-xl p-4 border-2 border-blue-400"
                              >
                                <div className="flex items-center gap-3 mb-2">
                                  <span className="text-3xl">🏛️</span>
                                  <span className="text-blue-200 font-bold">Chính phủ quyết định</span>
                                </div>
                                <p className="text-yellow-300 text-xl font-bold pl-10">
                                  "Hỗ trợ 500đ/kWh"
                                </p>
                                <p className="text-blue-200 text-sm pl-10">
                              ...
                              >
                                <div className="flex items-center justify-between mb-2">
                                  <div className="flex items-center gap-3">
                                    <span className="text-3xl">⚡</span>
                                    <span className="text-green-200 font-bold">EVN</span>
                                  </div>
                                  <div className="text-3xl">→</div>
                                  <div className="flex items-center gap-3">
                                    <span className="text-3xl">👥</span>
                                    <span className="text-green-200 font-bold">Dân</span>
                                  </div>
                                </div>
                                <p className="text-white text-xl font-bold text-center">
                                  Thu: 2.000đ/kWh
                              ...
                              <div className="flex justify-center">
                                <motion.div className="text-4xl text-green-400">➕</motion.div>
                              </div>
                              ...
                              <motion.div
                                ...
                                animate={{ opacity: 1, y: 0 }}
                                transition={{ delay: 2 }}
                                className="bg-orange-900/50 rounded-xl p-4 border-2 border-yellow-400"
                              >
                                <div className="flex items-center justify-between mb-2">
                                  <div className="flex items-center gap-3">
                                    <span className="text-3xl">💰</span>
                                    <span className="text-yellow-200 font-bold">NSNN</span>
                                  </div>
                                  <div className="text-3xl">→</div>
                                  <div className="flex items-center gap-3">
                                    <span className="text-3xl">⚡</span>
                                    <span className="text-yellow-200 font-bold">EVN</span>
                                  </div>
                                </div>
                                <div className="bg-yellow-500/20 rounded-lg p-3 mt-2">
                                  <motion.p 
                                    className="text-3xl font-bold text-yellow-300 text-center"
                              ...
                              <motion.div
                                ...
                                className="bg-gradient-to-r from-green-700 to-emerald-700 rounded-xl p-6 border-4 border-green-300"
                              >
                                <div className="text-center mb-3">
                                  <span className="text-5xl">🎉</span>
                                  <p className="text-yellow-300 font-bold text-xl mt-2">KẾT QUẢ</p>
                                </div>
                                <div className="bg-green-950/70 rounded-lg p-4 mb-3">
                                  <p className="text-2xl font-bold text-green-200 text-center">
                                    EVN đủ chi phí!
                                  </p>
                                  <p className="text-lg font-mono text-white text-center mt-2">
                                    2.000đ + 500đ = 2.500đ ✅
                                  </p>
                                </div>
                                <div className="space-y-2 text-green-200 text-sm">
                                  <p className="flex items-center gap-2">
                                    <span>✅</span>
                                    <span>EVN không lỗ, kinh doanh bền vững</span>
                                  </p>
                                  <p className="flex items-center gap-2">
                                    <span>✅</span>
                                    <span>Chi phí PSO minh bạch trong NSNN</span>
                                  </p>
                                  <p className="flex items-center gap-2">
                                    <span>✅</span>
                                    <span>Quốc hội kiểm soát được ngân sách</span>
                                  </p>
                                </div>
                              </motion.div>
                            </div>
                    ...
                    <motion.div
                      ...
                      className="mt-8 bg-gradient-to-r from-purple-900/50 to-blue-900/50 rounded-2xl p-8 border-2 border-purple-400/50"
                    >
                      <p className="text-center text-white text-xl font-bold mb-3">
                        <span className="text-4xl mr-3">💡</span>
                        BÀI HỌC QUAN TRỌNG
                        <span className="text-4xl ml-3">💡</span>
                      </p>
                      <p className="text-center text-purple-200 text-lg leading-relaxed">
                        Khi <strong className="text-yellow-300">minh bạch hóa nhiệm vụ công ích (PSO)</strong>, 
                        mọi bên đều được lợi: EVN kinh doanh hiệu quả, 
                        Nhà nước kiểm soát ngân sách, 
                        và Người dân nhận được dịch vụ tốt hơn!
                      </p>
                    </motion.div>
                  </motion.div>
                </motion.div>
